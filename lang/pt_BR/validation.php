...
return [
    ...
    */
    ...
    | linha de linguagem personalizada específica para uma regra de atributo dada.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | As seguintes linhas de linguagem são usadas para substituir o espaço reservado de atributo
    | por algo mais amigável, como "Endereço de E-Mail" em vez de "email". Isso simplesmente nos ajuda
